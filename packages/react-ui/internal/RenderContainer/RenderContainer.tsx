...
import { renderTarget, globalThat } from '../../lib/SSRSafe';
...
export class RenderContainer extends React.Component<RenderContainerProps> {
  ...
  private createContainer() {
    if (canUseDOM) {
      const domContainer = renderTarget.createElement('div');
  ...
  private mountContainer() {
    ...
    if (this.domContainer && this.domContainer.parentNode !== renderTarget.body) {
      renderTarget.body.appendChild(this.domContainer);
